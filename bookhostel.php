...
if(isset($_POST['submit'])){
    ...
    if (empty($result->num_rows)) {
        ...
        if( !empty($RoomType) || !empty($RoomNumber) || !empty($Duration) || !empty($Fees) ){
            $sql = mysqli_query($conn, "INSERT INTO `hostel_booking`(`room_type`,`room_number`,`duration`,`fees`, `student_id`, `student_name`, `email`, `phonenumber`,`gender`, `course`) 
            VALUES ('$RoomType','$RoomNumber','$Duration','$Fees', '$studentid', '$studentname', '$email', '$phonenumber', '$gender', '$course' )");
